...
class NlpPipeline:
    ...
    def __init__(self, textfile, max_length, context=False, sep="\t", usecols=None, tokenize_sentences=False,
                 ...
                 nlp=None, nlp_object_path=None, vectors=None, skip="<SKIP>", merge=False, num_threads=8,
        ...
        # Initializing timer dict, keys will be the message, values will be start time
        self.timer_dict = {}

        # TODO - Either take timer out or find a better way to do it.
        # Pass a message to start a timer
        self.timer(message="run tokenizer method")
        self.tokenize()
        # Use same message as before to end the timer
